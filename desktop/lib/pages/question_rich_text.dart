        ...
        switch (block.type) {
          case _BlockType.divider:
            return const Padding(
              ...
              child: Divider(color: DesktopTheme.border, thickness: 1, height: 1),
            );
                    ...
                    errorWidget: (_, __, ___) => SizedBox(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.broken_image, size: 32, color: DesktopTheme.textTertiary),
                            const SizedBox(height: 4),
                            Text('图片加载失败', style: TextStyle(fontSize: 12, color: DesktopTheme.textTertiary)),
                          ],
                        ),
                      ),
                    ),
      ...
      if (pos + 2 < text.length && text[pos] == '_' && text[pos + 1] == '_' && text[pos + 2] == '_') {
        ...
        if (revealed && answerIndex < answers.length) {
          ...
          spans.add(TextSpan(
            text: ' ______ ',
            style: TextStyle(
              backgroundColor: DesktopTheme.indigo100,
              fontWeight: FontWeight.w600,
              fontSize: fontSize,
              fontFamily: 'Microsoft YaHei',
            ),
