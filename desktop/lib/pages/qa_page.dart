...
class _QaPageState extends State<QaPage> {
  ...
  String _getCategoryName(String? categoryId) {
    ...
    final bank = _banks.where((b) => b.id == categoryId).firstOrNull;
    return bank?.name ?? '未知';
  }
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // Bank filter chips
          if (_banks.isNotEmpty && widget.initialCategoryId == null)
            SizedBox(
              height: 40,
              child: ListView(
                ...
                children: [
                  Padding(
                    ...
                    child: _FilterChip(label: '全部', selected: _categoryId == null, onTap: () {
                      setState(() { _categoryId = null; _currentPage = 1; });
                      _loadQas();
                    }),
                  ),
                  ..._banks.map((b) => Padding(
                    padding: const EdgeInsets.only(right: 6),
                    child: _FilterChip(label: b.name, selected: _categoryId == b.id, onTap: () {
                      setState(() { _categoryId = b.id; _currentPage = 1; });
                      _loadQas();
                    }),
                  )),
                ],
                ...
                : _qas.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (ctx, i) {
                          ...
                          return _QaCard(
                            qa: qa,
                            bankName: _getCategoryName(qa.categoryId),
                            accColor: accColor,
                            onTap: () async {
